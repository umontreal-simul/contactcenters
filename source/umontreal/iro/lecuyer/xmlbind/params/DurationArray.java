...
@XmlType(name = "DurationArray", propOrder = {
    "rows"
})
public class DurationArray {
     ...
     * {@link DurationArray.Row }
     * 
     * 
     */
    public List<DurationArray.Row> getRows() {
        if (rows == null) {
            rows = new ArrayList<DurationArray.Row>();
        }
        return this.rows;
    }
     ...
     * &lt;complexType>
     *   &lt;simpleContent>
     *     &lt;extension base="&lt;http://www.iro.umontreal.ca/lecuyer/ssj>durationList">
