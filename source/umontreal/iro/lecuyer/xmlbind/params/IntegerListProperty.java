...
@XmlType(name = "IntegerListProperty", propOrder = {
    "value"
})
    ...
    extends AbstractProperty
{
    ...
    public int[] getValue() {
        ...
        int[] retVal = new int[this.value.length] ;
    ...
    public void setValue(int[] values) {
        ...
        this.value = ((int[]) new int[len] );
        for (int i = 0; (i<len); i ++) {
            this.value[i] = new Integer(values[i]);
        }
    }
    ...
    public int setValue(int idx, int value) {
        return this.value[idx] = new Integer(value);
    }
